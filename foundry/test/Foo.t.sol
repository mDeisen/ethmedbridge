...
import { HealthRecordRegistryMock } from "../src/mock/HealthRecordRegistryMock.sol";
...
contract HealthRecordRegistryTest is PRBTest, StdCheats {
    HealthRecordRegistryMock internal _registry;

    /// @dev A function invoked before each test case is run.
    function setUp() public virtual {
        _registry = new HealthRecordRegistryMock();
    }
